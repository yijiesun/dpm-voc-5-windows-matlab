...
conf = cv(conf, 'version', 'INRIA_2019');
...
conf = cv(conf, 'pascal.dev_kit', 'F:\voc\VOCdevkit\');
% For INRIA person                                   
...
conf = cv(conf, 'training.train_set_fg', 'tran_inria');
conf = cv(conf, 'training.train_set_bg', 'tranval_inria');
...
VOCopts.resdir = 'F:/voc/VOCdevkit/results/INRIA2019/';
VOCopts.localdir = 'F:/voc/VOCdevkit/local/INRIA2019/';
VOCopts.annopath = 'F:/voc/VOCdevkit/INRIA/Annotations/%s.xml';
VOCopts.imgpath = 'F:/voc/VOCdevkit/INRIA/JPEGImages/%s.jpg';
VOCopts.imgsetpath = 'F:/voc/VOCdevkit/INRIA/ImageSets/Main/%s.txt';
VOCopts.clsimgsetpath = 'F:/voc/VOCdevkit/INRIA/ImageSets/Main/%s_%s.txt';
VOCopts.clsrespath = 'F:/voc/VOCdevkit/results/INRIA/Main/%s_cls_val_%s.txt';
VOCopts.detrespath = 'F:/voc/VOCdevkit/results/INRIA/Main/%s_det_val_%s.txt';
VOCopts.exannocachepath = 'F:/voc/VOCdevkit/local/INRIA/%s_anno.mat';
VOCopts.exfdpath = 'F:/voc/VOCdevkit/local/INRIA/%s_fd.mat';
