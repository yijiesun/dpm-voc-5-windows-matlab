...
if nargin < 3
  ...
  eval([mexcmd ' features/resize.cpp']);
  eval([mexcmd ' features/features.cpp']);
  eval([mexcmd ' gdetect/dt.cpp']);
  eval([mexcmd ' gdetect/bounded_dt.cpp']);
  eval([mexcmd ' gdetect/get_detection_trees.cpp']);
  eval([mexcmd ' gdetect/compute_overlap.cpp']);
  % Convolution routine
  ...
  eval([mexcmd ' gdetect/fconv_var_dim.cpp -output fconv']);
  ...
  eval([mexcmd ' gdetect/fconv_var_dim.cpp -output fconv_var_dim']);
else
